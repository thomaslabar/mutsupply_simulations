...
function run_sim()
    ...
    save_populations(save_file_name,large_populations,params,"Large_repaired",false)
    ...
    save_populations(save_file_name,small_populations,params,"Small_equalgen",true)
    ...
    save_populations(save_file_name,small_populations,params,"Small_repaired",true)
    ...
    save_populations(save_file_name,small_populations,params,"Small_totalsupply",true)
